    ...
    public partial class AccountDetail : Form
    {
        ...
        private void AccountDetail_Load(System.Object sender, System.EventArgs e)
        {
            ...
            if (AccountEntry != null)
            {
                ...
                if (DBNull.Value.Equals(AccountEntry["FullName"]) == false) AccountName.Text = (string)AccountEntry["FullName"];
                if (DBNull.Value.Equals(AccountEntry["AnnualFee"]) == false) AnnualFee.Text = string.Format("{0:0.00}", (decimal)AccountEntry["AnnualFee"]);
                if (DBNull.Value.Equals(AccountEntry["StartDate"]) == false) StartDate.Text =    string.Format("{0:d}", (DateTime)AccountEntry["StartDate"]); }
        }
